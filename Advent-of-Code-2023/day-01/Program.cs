...
void GetPositionsOfWordsInString(Dictionary<string, List<int>> foundWords, out string smallestNumber, out string largetsNumber, out int smallestNumberPosition, out int largetsNumberPosition)
{
    smallestNumber = "";
...
string JustNumbers(string regexPattern, string line)
{
    MatchCollection mc = Regex.Matches(line, regexPattern);
...
Dictionary<string, List<int>> FindNumbersInString(List<string> numbers, string line)
{
