...
bool CalculatePartNumber(string[] input, int x, int y, int numSize)
{
...
void GetPositions(string[] input, int starY, int starX, out int x1, out int x2, out int y1, out int y2)
{
    x1 = -1;
    x2 = -1;
    y1 = -1;
...
int FindNumberBasedOnOperatorPosition(string row, int x1)
{
    bool isFound = false;
    string num = "";
